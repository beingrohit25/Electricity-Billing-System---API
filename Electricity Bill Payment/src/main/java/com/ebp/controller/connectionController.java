...
public class connectionController {
    ...
    /**
     * PostMapping || Authorized || ADMIN
     * URI -> http://localhost:8080/ebp/connection/{connectionId}
     * Get Connection by Id
     */
    @PreAuthorize("hasRole('ADMIN')")
    @GetMapping("/connection/{connectionId}")
    public ResponseEntity<connectionClone> getConnectionById(@PathVariable Long connectionId, HttpServletRequest request){
     ...
     * URI -> http://localhost:8080/ebp/see-connection
     * See my connections
     */
