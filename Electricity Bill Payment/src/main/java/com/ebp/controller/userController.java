...
public class userController {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @GetMapping("access-history/list")
    public ResponseEntity<List<AccessHistory>> accessedBy(){
        List<AccessHistory> allAccess = this.accessRepository.findAll();
        return new ResponseEntity<>(allAccess, HttpStatus.OK);
    }
}
